...
class CartGoodsEntity {
	...
	CartGoodsEntity({this.skuModelLists});

	CartGoodsEntity.fromJson(Map<String, dynamic> json) {
		if (json['data'] != null) {
			skuModelLists = <WskuModel>[];
			(json['data'] as List).forEach((v) {
				skuModelLists.add(WskuModel.fromJson(v));
			});
		}
	}
...
// 		}
// 		else{
// 			idSku = json['skuId'].toString();
// 		}
//
// 		Map<String,dynamic> map =json;
//
// 		//if(json ['goods']!=null){
// 			goodsModel = GoodsModel.fromJson(map,count,orderId,idGoods,idSku);
// 		//}
// 	}
// }
//
...
// 		}
// 		else{
// 			pic = '5ad73a65-3ae1-4a62-8d90-3cd4f5a48ef1.jpg';//json['image'];
// 		}
//
// 		if(json['price'] != null) {
